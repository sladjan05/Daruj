...
import net.jsoft.daruj.welcome.presentation.viewmodel.WelcomeEvent
import net.jsoft.daruj.welcome.presentation.viewmodel.WelcomeTask
import net.jsoft.daruj.welcome.presentation.viewmodel.WelcomeViewModel
    ...
    BoxWithConstraints(
        ...
        Column(
            ...
            PrimaryButton(
                ...
                onClick = {
                    viewModel.onEvent(WelcomeEvent.Next)
                }
            )
