...
import net.jsoft.daruj.common.misc.FirstParentNestedScrollConnection
...
): Modifier = if (statement) then(ifModifier) else then(elseModifier)
...
fun Int.getValue(context: Context, vararg args: Any) = context.getString(this, *args)
...
@Composable
fun rememberFirstParentNestedScrollConnection(scrollState: ScrollState) = remember {
    FirstParentNestedScrollConnection(scrollState)
}
